...
// TestApp.Mfc.cpp : Defines the class behaviors for the application.
//
...
CTestAppMfcApp::CTestAppMfcApp() noexcept
{
...
BOOL CTestAppMfcApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_TestAppMfcTYPE,
		RUNTIME_CLASS(CTestAppMfcDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CTestAppMfcView));
	if (!pDocTemplate)
		return FALSE;
...
void CTestAppMfcApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CTestAppMfcApp::LoadCustomState()
{
}

void CTestAppMfcApp::SaveCustomState()
{
}
